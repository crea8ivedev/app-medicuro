...
const BookAppointmentIndexPage = lazy(
  () => import('./pages/BookAppointment/index'),
)
        ...
        <Route element={<PrivateRoute />}>
          <Route element={<DefaultLayout />}>
            ...
            <Route
              ...
              element={<BookAppointmentIndexPage />}
            />
            <Route
            ...
            />
            <Route
              path='/rebook-appointment/:id'
              element={<RebookAppointment />}
            />
            <Route
              path='/view-appointment/:type/:id'
              element={<ViewlAppointment />}
            />
          </Route>
