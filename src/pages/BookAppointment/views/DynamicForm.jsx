    ...
    <div>
      {!fields?.length ? (
        <div className='text-white'>
          {' '}
          Our team is currently setting this up, and the form will be available
          shortly.
        </div>
      ) : (
          ...
          <div className='pb-10 space-y-5'>
              ...
              <div key={field.name}>
                {field.type === 'file' ? (
                  ...
                  <Field
                    name={field?.name ?? ''}
                    component={
                      field.type === 'select' ? CommonSelectBox : CustomInput
                    }
                    options={field?.options}
                    inputclasses='w-full'
                    rows={
                      field.type === 'textarea' ? field?.rows || 6 : undefined
                    }
            ...
            <div className='md:text-end text-center mt-5'>
              <button
                ...
                className={cn(
                  'common-btn btn-loader relative',
