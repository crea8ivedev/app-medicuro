...
const BookAppointmentItem = ({name,isFeesApply=false,isSelected=false,onClick=(id) => {},id}) => {
    return <div onClick={() => onClick(id)} className={cn("relative h-100 cursor-pointer text-center text-sm  rounded-md flex flex-col items-center justify-center font-semibold px-3 py-2",isSelected ? "bg-teal-400" : "bg-teal-200")}>
