...
export default function Dashboard() {
  ...
  return (
    <div className='bg-ice min-h-screen w-full justify-between relative'>
      ...
      <div className='container mx-auto  flex items-center justify-between relative md:px-5'>
        <img className='left-image' src={loginSideImg} alt='' />
              ...
              <div className="flex bg-white gap-10 rounded-xl py-4 ps-10 pe-5">
                  <div className="flex flex-col gap-1">
                    ...
                    <NavLink to="/book-appointment">
                        <div className="flex flex-col gap-2 justify-center items-center bg-teal p-4 rounded-xl">
                          <img src={plusBtn} alt="" />
