...
function RebookAppointment() {
  ...
  const rebookAppoinment = async (appointmentId) => {
    try {
      setLoading(true)
      const response = await axiosInstance.post('/api/v1/appointments/rebook', {
        appointmentId,
      })
  ...
  return (
    <div className='bg-ice min-h-[calc(100dvh-64px)] 2xl:min-h-[calc(100dvh-93px)] w-full justify-between relative flex flex-col'>
      <div className='common-bg'></div>

      <div className='container mx-auto flex-1 flex items-center justify-around relative'>
        <img className='left-image' src={sideImage} alt='' />

        <div>
          <div className='bg-teal max-w-650 max-h-max mt-4 pt-10 md:px-10 px-5 py-15 md:pb-24 rounded-xl'>
            <div className='max-w-500'>
              ...
              <div className='flex flex-col gap-4 mb-10'>
                <div>
                  ...
                  <span className='font-bold'>rebook</span> your appointment
                ...
                {appointment && (
                  <AppointmentItem
                    buttons={[
                      {
                        name: 'Confirm',
                        action: (index) => rebookAppoinment(index),
                      },
                    ]}
