        ...
        <div className='flex sm:flex-col items-center gap-2 my-3 md:my-0'>
          {buttons.map((item, index) => {
            return (
              <button
                disabled={isLoading}
                className={cn('btn-loader  bg-white py-1 px-2 md:min-w-[62px] rounded-md text-xs  cursor-pointer hover:bg-[#CED4DA]',buttonClasses,isLoading ? "opacity-90 cursor-not-allowed" : "")}
